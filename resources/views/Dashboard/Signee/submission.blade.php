              ...
              <table class="table" id="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @endif
                    <td>
                    <a href="/signee/submissions/{{$datas->id}}" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" title="Detail" >
                        <i class="bi bi-file-earmark-pdf"></i>
                    </a>
                    @if($datas->status == 1)
                    <a href="/signee/submissions/delete/{{$datas->id}}" class="btn btn-danger btn-sm" 
                        onclick="return confirm('Anda yakin ingin menghapus data?')" 
                        data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus">
                        <i class="bi bi-trash"></i>
                    </a>
                    @endif
                    @if($datas->status == 1 && $datas->documents_count == 1)
                    <a class="btn btn-warning btn-sm" data-bs-toggle="tooltip" title="Edit" >
                        <i class="bi bi-pencil-square" data-bs-toggle="modal" data-bs-target="#editModal{{$datas->id}}"></i>
                      </a>
                    @endif
